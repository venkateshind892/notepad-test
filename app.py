...
.stApp {
    background:
        radial-gradient(circle at 20% 20%, rgba(80, 70, 200, 0.30), transparent 35%),
        radial-gradient(circle at 80% 30%, rgba(0, 180, 255, 0.20), transparent 35%),
        radial-gradient(circle at 50% 100%, rgba(150, 50, 220, 0.18), transparent 40%),
        #070a12;
    color: white;
}
...
.stButton > button:hover {
    transform: translateY(-2px);
    box-shadow: 0 10px 25px rgba(80,120,255,0.25);
}
...
if st.session_state.logged_in:
    ...
    st.write(
        ...
        "You can now add your ReqPilot features here."
    )
...
st.markdown(
    '<div class="title">ReqPilot</div>',
    unsafe_allow_html=True
)

st.markdown(
    '<div class="subtitle">AI Requirements Engineering Agent</div>',
    unsafe_allow_html=True
)
